...
const OrderDetailsPage = () => {
  ...
  const paymentHandler = async e => {
    try {
      ...
      if (!razorpayApiKey || !razorpayApiKey.razorpayKeyId) {
        toast.error("Razorpay API key is not available");
        return;
      }

      const razorpayData = {
        amount: order.totalPrice * 100, // Razorpay expects the amount in paisa
        currency: 'INR',
      ...
      console.log('Razorpay order response:', data); // Debug the response
